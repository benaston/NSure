namespace NSure
{
    ...
    ///   subsystem.
    /// </summary>
    public class InvalidAssertionFailureExceptionException<TException> : HelpfulException
    {
        ...
        public InvalidAssertionFailureExceptionException(Exception innerException = default(Exception))
