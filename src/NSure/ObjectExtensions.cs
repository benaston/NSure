namespace NSure
{
    ...
    public static class ObjectExtensions
    {
        ...
        public static T EnsuringThat<T, TException>(this T o, Func<T, bool> assertionAboutO, string message) where TException : Exception, new()
        {
            if (assertionAboutO(o)) { return o; }
